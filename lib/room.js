...
Room.prototype.doManagerCheck = function(){
	if(this.removal != undefined) clearTimeout(this.removal);
	...
	var self = this;
	this.removal = setTimeout(function(){
		self.tent.removeRoom(self.room_name);
	}, 1000);
};
...
Room.prototype.hasEntryTicket = function(ticket, check_soiled) {
	if(this.tickets[ticket*1] == undefined) return false;
	return this.tickets[ticket*1].canGainEntry(check_soiled);
};
